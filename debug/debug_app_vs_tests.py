#!/usr/bin/env python3
"""
Debug script to compare app vs tests behavior with the same audience definitions.
"""
...
def debug_app_vs_tests():
    """Compare app vs tests behavior"""
    print("=== Debug: App vs Tests Comparison ===")
    ...
    output_path = "debug_app_vs_tests.pptx"
    ...
    if len(group_charts) == 0:
        ...
        print("   The app and tests are using different logic.")
    else:
