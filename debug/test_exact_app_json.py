#!/usr/bin/env python3
"""
Test script for the exact JSON from the app.
"""
...
def test_exact_app_json():
    """Test the exact JSON from the app"""
    print("=== Testing Exact App JSON ===")
    ...
    output_path = "test_exact_app_json.pptx"
    ...
    print(f"Expected group charts: {len(app_json['__groups__']) * len(raw_audience_data)}")
